...
You can [deploy Exter](#buil--run) on your own infrastructure, on-premises or cloud. Or leverage the [pre-hosted Exter](https://btnguyen2k.github.io/exter/).

## Build & Run

`Exter` is composed of 2 components that can be built and deployed separatedly.
- [Frontend](fe-gui/):
